...
|---|---|---|---|---|
| ANDREY | `AI_CHARACTERS/ANDREY` | FACE_CANON_ACTIVE / BODY_CANON_ACTIVE / CONTROL_TESTS_PENDING | WORKING / BODY CANON INCLUDED — 6 scene presets, all referenced files exist | Run Andrey control tests and create `ANDREY_TEST_RESULTS.md` (see `.voyage/CURRENT_TASK.md`); not yet CANON_READY_2D |
