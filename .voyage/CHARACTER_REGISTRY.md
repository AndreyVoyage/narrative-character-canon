...
|---|---|---|---|---|
| ANDREY | `AI_CHARACTERS/ANDREY` | FACE_CANON_ACTIVE / BODY_PENDING | WORKING — 6 scene presets, all referenced files exist | Body canon prompt kit ready (`ANDREY_BODY_CANON_PROMPT.txt` + negative prompt); generation is REQUESTED-gated, not started (see `.voyage/CURRENT_TASK.md`) |
