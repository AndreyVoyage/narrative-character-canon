...
| NIKA | `AI_CHARACTERS/NIKA` | BASE_CANON_APPROVED / CONTROL_TESTS_APPROVED (Tests 01–03 published, incl. TEST01 MAIN + ALT) / PROMPT_PIPELINE_ACTIVE | WORKING — base canon + 4 approved sheets (face, expressions, body A, body B poses) + 4 control-test images (TEST01 MAIN + ALT, TEST02, TEST03); 6 imported raw references (D-034); 8 prompt-run records; canon index, test results, and prompt infrastructure published | Awaiting human selection of next coverage target for NIKA |
| SERGEY | `AI_CHARACTERS/SERGEY` | BASE_CANON_APPROVED / CONTROL_TESTS_APPROVED / PROMPT_PIPELINE_ACTIVE | WORKING — face/expression/body canon + 3 approved control tests (incl. sports yoga); sports scene preset | Awaiting human selection of next coverage target |
| MAKSIM | `AI_CHARACTERS/MAKSIM` | VISUAL_CANON_PUBLISHED / PUBLISHED_AND_VERIFIED | APPROVED — 3 core canon images, 6 support assets, 9 prompt-run records, prompt pipeline complete, metadata normalized, independent QA 23/23; published HEAD `e33403712e60dc2cdc2e89d7801a41f49dbd8764` on `origin/main` | NONE — CLOSED |
...
| EGOR | `AI_CHARACTERS/EGOR` | BASE_CANON_APPROVED / CONTROL_TESTS_APPROVED (Tests 01–03 published) / PROMPT_PIPELINE_ACTIVE | WORKING — base canon + tests 01–03 published; prompt pipeline active (6 records); 5 owner-classified visual references in 01_refs_raw/; VNE text canon synced (D-028); stubble deferred | Awaiting human selection of the next coverage target; body canon B (pose variations) not yet generated or imported |
