...
| MARINA | `AI_CHARACTERS/MARINA` | BASE_CANON_APPROVED / CONTROL_TESTS_PENDING / PROMPT_PIPELINE_ACTIVE | WORKING — 3 base-canon images approved (face, expressions, body), prompt pipeline active, reference presets updated | Run control tests; await human selection for next generation target |
