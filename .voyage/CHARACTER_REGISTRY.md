...
| EGOR | `AI_CHARACTERS/EGOR` | BASE_CANON_APPROVED / CONTROL_TESTS_APPROVED (Tests 01–03 published) | IDENTITY_SUMMARY + CANON_GENERATION_PROMPTS synced with VNE (D-028): 180 cm, 83 kg, cleft chin, aquiline nose added; face canon, expression canon, and body canon A (front/side/back) imported from external human-approved source and registered; 5 owner-classified visual references in 01_refs_raw/; inactive facial-hair canon (stubble deferred); prompt pipeline active (6 records); 3 control tests published (neutral portrait, evening embankment, sports yoga) | Body canon B (pose variations) not yet generated or imported |
