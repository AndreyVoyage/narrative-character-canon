...
| EGOR | `AI_CHARACTERS/EGOR` | BASE_CANON_APPROVED | IDENTITY_SUMMARY + CANON_GENERATION_PROMPTS synced with VNE (D-028): 180 cm, 83 kg, cleft chin, aquiline nose added; face canon, expression canon, and body canon A (front/side/back) imported from external human-approved source and registered; 5 owner-classified visual references in 01_refs_raw/; inactive facial-hair canon (stubble deferred); prompt pipeline active (3 records) | Control tests not started; body canon B (pose variations) not yet generated or imported |
