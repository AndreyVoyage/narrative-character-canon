...
* Primary selected face reference:
...
05 mature scale / tall body check  
06 cinematic indoor portrait  
07 confident outdoor lifestyle  
08 character poster  
09 interaction test (after base canon approval is now satisfied)
...
Base canon and initial control tests are approved locally.  
Prompt logging is normalized. Future generations must record prompt_id, references, output path, verdict, and notes.
